...
<body>
    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-7xl p-8 space-y-8 glassmorphism relative">
            ...
            <div class="text-center">
                ...
                </a><p class="mt-2 text-lg themed-text-secondary">Konversi perintah build Anda secara otomatis dengan sentuhan ajaib.</p>
            </div>
    ...
    <script>
        ...
        function convertCommand() {
            ...
            const customerBlockRegex = /(\w+_(?:sea|eur|mea)_openx?)\s+([A-Z_ ]+?)(\s*)$/;
